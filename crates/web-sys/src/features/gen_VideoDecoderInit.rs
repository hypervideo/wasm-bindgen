...
#[cfg(web_sys_unstable_apis)]
#[doc = "The trait to access properties on the `VideoDecoderInit` dictionary."]
#[doc = ""]
#[doc = "*This API requires the following crate features to be activated: `VideoDecoderInit`*"]
pub trait VideoDecoderInitGetters {
    #[cfg(web_sys_unstable_apis)]
...
#[cfg(web_sys_unstable_apis)]
impl VideoDecoderInitGetters for VideoDecoderInit {
    #[cfg(web_sys_unstable_apis)]
    fn error(&self) -> &::js_sys::Function {
    ...
    fn output(&self) -> &::js_sys::Function {
        use wasm_bindgen::JsValue;
        let r = ::js_sys::Reflect::get(self.as_ref(), &JsValue::from("output"));
        let r = r.expect("getting properties should never fail on our dictionary objects");
        ::wasm_bindgen::JsCast::unchecked_into(r)
    }
}
